...
class CustomFloatingTextField extends StatelessWidget {
  ...
  Widget get floatingTextFieldWidget => SizedBox(
        ...
        child: TextFormField(
          ...
          autofocus: autofocus!,
          style: textStyle ?? CustomTextStyles.bodySmallGray900,
  ...
  InputDecoration get decoration => InputDecoration(
        hintText: hintText ?? "",
        hintStyle: hintStyle ?? CustomTextStyles.bodySmallGray900,
        labelText: labelText ?? "",
        ...
        isDense: true,
        contentPadding:
            contentPadding ?? EdgeInsets.fromLTRB(9.h, 28.v, 9.h, 9.v),
        fillColor: fillColor,
        filled: filled,
