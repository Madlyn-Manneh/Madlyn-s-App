                    ...
                    child: Column(
                      children: [
                        ...
                        _buildScreenTitle(
                          ...
                          screenTitle: "About",
                          onTapScreenTitle: () =>
                              onTapScreenTitle(context, AppRoutes.aboutScreen),
                        ),
                        _buildScreenTitle(
                          context,
                          screenTitle: "List Destination",
                          onTapScreenTitle: () => onTapScreenTitle(
                              context, AppRoutes.listDestinationScreen),
                        ),
                        _buildScreenTitle(
                          context,
                          screenTitle: "Detail Destination",
                          onTapScreenTitle: () => onTapScreenTitle(
                              context, AppRoutes.detailDestinationScreen),
                        ),
                        _buildScreenTitle(
                          context,
                          screenTitle: "Message One",
                          onTapScreenTitle: () => onTapScreenTitle(
                              context, AppRoutes.messageOneScreen),
                        ),
                        _buildScreenTitle(
                          context,
                          screenTitle: "Message",
